...
def Generador_Encuesta():
    ...
    while(True):  #mientras las filas sean menor a 50
        if filas < 50 :
            ...
            break
#region Miscelaneos
def DataGen(filas): #Genera una lista de largo indicado con datos aleatorios
    try:
        ...
        print("Ha surgido un error en la generacion de respuestas")
def FileWrite(datos): #Escribe los datos en un archivo CSV
    try:
